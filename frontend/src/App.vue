<template>
  <nav>
    ...
    <div class="nav-left">
      <!-- home  -->
      <router-link to="/"><svg t="1666344612143" id="icon-home" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5425" width="32" height="32"><path d="M946.488889 505.002667l-411.875556-411.591111a31.914667 31.914667 0 0 0-45.226666 0l-411.875556 411.591111c-12.003556 12.003556-18.830222 28.302222-18.830222 45.283555a64.056889 64.056889 0 0 0 64 64H166.115556v293.717334c0 17.692444 14.307556 32 32 32h249.912888v-224h111.985778v224h265.898667c17.720889 0 32-14.307556 32-32V614.286222h43.406222a64.056889 64.056889 0 0 0 45.226667-109.283555z" p-id="5426" fill="#ffffff"></path></svg></router-link> |
      <!-- rightarrow -->
      <router-link to="/info"><svg t="1666271128973" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9310" width="48" height="48"><path d="M393.151172 263.251659c-12.489452 12.489452-12.489452 32.737612 0 45.227064L596.673471 512 393.151172 715.521277c-12.489452 12.489452-12.489452 32.737612 0 45.227064 12.489452 12.489452 32.737612 12.489452 45.227064 0l226.13532-226.135321c12.489452-12.489452 12.489452-32.737612 0-45.227064L438.378236 263.251659c-12.488429-12.489452-32.737612-12.489452-45.227064 0z" p-id="9311" fill="#ffffff"></path></svg></router-link>
      <!-- verticle line  -->
      <svg t="1666345076703" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6710" width="48" height="48"><path d="M474.91 67h74.19v890h-74.19z" p-id="6711" fill="#8a8a8a"></path></svg>
      <!-- audio music  -->
